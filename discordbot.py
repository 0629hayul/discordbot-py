...
async def on_message(message):
    ...
    if message.content == f'{PREFIX}tck p':
        ...
        embedVar.add_field(name="",value="**member** : 서버 가입ㅣ혜택 : 2,000젠 무료지급", inline=False)
        await message.channel.send(embed=embedVar) 
